#!/usr/bin/env python3
"""Regression tests for the clean B6-l6 root-cardinality certificate."""

import tempfile
import unittest
from pathlib import Path

import check_m6_clean_sink_B6_l6_root_cardinality as checker
import verify_m6_clean_sink_B6_l6_root_cardinality_certificate as verifier


class CleanB6L6RootCardinalityTest(unittest.TestCase):
    def test_cover(self):
    ...
    def test_exact_group_dimensions(self):
        ...
        self.assertEqual((len(members), len(names), len(clauses), delta), (220, 25849, 184296, (2013, 7899)))
    ...
    def test_rejects_ledger_group_mutation(self):
        data = verifier.LEDGER.read_text(encoding="ascii").replace("B6-l6\t220", "B6-l5\t220", 1)
