#!/usr/bin/env python3
"""Regression and hostile tests for the B7-l3 19-profile campaign."""

import tempfile
import unittest
from pathlib import Path

import check_m6_b7_l3_profile_root_cardinality as checker
...
class B7L5ProfileRootCardinalityTest(unittest.TestCase):
    ...
    def test_exact_census(self):
        self.assertEqual(len(self.profiles), 19)
        self.assertEqual(sum(len(profile[7]) for profile in self.profiles), 32574)
