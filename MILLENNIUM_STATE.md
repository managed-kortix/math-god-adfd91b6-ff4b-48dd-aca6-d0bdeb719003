...
- **active main funnel:** Cycle 186 finds that the selected cyclotomic
  ...
  More decisively, the Cycle 185 anchor `1289` has `(1289/29)=-1`, so that
  entire progression fails the Cycle 182 fixed-`29` admissibility equality and
  cannot produce an admissible collision under the stated packet.
